...
- (void)addCloseButton {
    ...
    [deleteBtn setImage:[UIImage ZHImageNamed:@"close_24@2x"] forState:UIControlStateNormal];
...
- (void)addView {
    ...
    for (int i = 0; i<3; i++) {
        ...
        [btn setTitleColor:[UIColor colorWithRGB:0x222222] forState:UIControlStateNormal];
        [btn setTitleColor:[UIColor colorWithRGB:0x2EB0FF] forState:UIControlStateSelected];
        ...
        if (i == 0) {
            ...
            _line.backgroundColor = [UIColor colorWithRGB:0x2EB0FF].CGColor;
