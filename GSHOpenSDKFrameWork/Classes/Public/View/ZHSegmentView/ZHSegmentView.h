...
typedef void(^SegmentItemClickBlock)(NSUInteger selectedIndex);

@interface ZHSegmentView : UIView

@property (nonatomic, copy) SegmentItemClickBlock segmentItemClickBlock;
...
@interface ZHSegmentViewItemCell : UICollectionViewCell
