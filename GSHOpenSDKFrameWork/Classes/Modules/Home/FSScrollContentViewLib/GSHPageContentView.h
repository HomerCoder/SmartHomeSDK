...
@class GSHPageContentView;

@protocol GSHPageContentViewDelegate <NSObject>
 ...
 */
- (void)FSContentViewWillBeginDragging:(GSHPageContentView *)contentView;
...
/**
 ...
 @param progress 滑动进度
 */
- (void)FSContentViewDidScroll:(GSHPageContentView *)contentView startIndex:(NSInteger)startIndex endIndex:(NSInteger)endIndex progress:(CGFloat)progress;
...
/**
 ...
 @param contentView FSPageContentView
 */
- (void)FSContenViewDidEndDragging:(GSHPageContentView *)contentView;

@end

@interface GSHPageContentView : UIView
...
@property (nonatomic, weak) id<GSHPageContentViewDelegate>delegate;
...
@property (nonatomic, weak, readonly)UIViewController *nextVC;
@property (nonatomic, weak, readonly)UIViewController *previousVC;
